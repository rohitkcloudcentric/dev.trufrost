...
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-mega-wrapper > li.current-menu-item > a{
	color: <?php echo $font_color_active1;?>;
}
<?php } ?>
/*Mega menu */
...
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout ul.wp-mega-sub-menu li:hover{
...
<?php if($widget_btnbgcolor != ''){ ?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-text-widgets .wwpmm-linkbtn,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-productlist-wrap .all-product-list li .wpmm-second-wrapper .wpmm-woo-content a.button, 
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-recent-product-widget .all-re-product-list li .wpmm-recentpro-right-section a.button{
	background: <?php echo $widget_btnbgcolor;?>;
	border: 1px solid <?php echo $widget_btnbgcolor;?>;
}
<?php } ?>
<?php if($widget_btnbghcolor != ''){ ?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-text-widgets .wwpmm-linkbtn:hover,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-productlist-wrap .all-product-list li .wpmm-second-wrapper .wpmm-woo-content a.button:hover, 
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-recent-product-widget .all-re-product-list li .wpmm-recentpro-right-section a.button:hover{
	background: <?php echo $widget_btnbghcolor;?>;
	border: 1px solid <?php echo $widget_btnbghcolor;?>;
}
<?php } ?>
<?php if($widget_btnfcolor != ''){ ?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-text-widgets .wwpmm-linkbtn a,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-recent-posts-widget a.wpmm-readmore-btn,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-productlist-wrap .all-product-list li .wpmm-second-wrapper .wpmm-woo-content a.button, 
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-recent-product-widget .all-re-product-list li .wpmm-recentpro-right-section a.button{
	color: <?php echo $widget_btnfcolor;?> !important;
}
<?php } ?>
<?php if($widget_btnfhcolor != ''){ ?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-text-widgets .wwpmm-linkbtn:hover a,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-recent-posts-widget a.wpmm-readmore-btn:hover,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-productlist-wrap .all-product-list li .wpmm-second-wrapper .wpmm-woo-content a.button:hover, 
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo $theme_slug;?> .wpmm-sub-menu-wrap li .wpmm-pro-recent-product-widget .all-re-product-list li .wpmm-recentpro-right-section a.button:hover{
	color: <?php echo $widget_btnfhcolor;?> !important;
}
<?php } ?>
...
@media screen and (max-width: <?php echo $resposive_breakpoint_width - 1;?>px){
